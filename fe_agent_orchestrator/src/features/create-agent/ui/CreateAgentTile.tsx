...
export function CreateAgentTile({ workspaceId }: Props) {
  return (
    <Link
    ...
    >
      ...
      <span className="text-[12px] font-medium text-ink">New agent</span>
      <span className="text-[10px] uppercase tracking-eyebrow text-ink-mute">open builder</span>
    </Link>
  );
}
