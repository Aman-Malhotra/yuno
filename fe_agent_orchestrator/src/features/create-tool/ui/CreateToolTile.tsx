...
export function CreateToolTile({ workspaceId }: Props) {
  return (
    <Link
      to="/workspaces/$workspaceId/tools/new"
      params={{ workspaceId }}
    ...
    >
      ...
      <span className="text-[12px] font-medium text-ink">New tool</span>
      <span className="text-[10px] uppercase tracking-eyebrow text-ink-mute">open registration</span>
    </Link>
  );
}
